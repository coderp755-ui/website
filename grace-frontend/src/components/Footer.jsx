      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400 mb-4">Grace</h3>
            <p className="text-gray-400 mb-4">
              Providing exceptional services to help you succeed. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/about" className="text-gray-400 hover:text-blue-400 transition duration-200">
                  About Us
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/contact" className="text-gray-400 hover:text-blue-400 transition duration-200">
                  Contact
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} Grace. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
